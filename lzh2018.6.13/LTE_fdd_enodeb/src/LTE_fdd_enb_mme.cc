...
void LTE_fdd_enb_mme::handle_rrc_msg(LTE_FDD_ENB_MESSAGE_STRUCT &msg)
{
    switch(msg.type)
    {
    case LTE_FDD_ENB_MESSAGE_TYPE_MME_NAS_MSG_READY://核心网中ＭＭＥ传递给ＲＲＣ层信令消息
        handle_nas_msg(&msg.msg.mme_nas_msg_ready);
        break;
    case LTE_FDD_ENB_MESSAGE_TYPE_MME_RRC_CMD_RESP://ＲＲＣ反馈给ＭＭＥ的消息
  ...
  /*  if(msg_type==LIBLTE_MME_MSG_TYPE_IDENTITY_RESPONSE)
    { 
       ...
       interface->send_debug_msg(LTE_FDD_ENB_DEBUG_TYPE_ERROR,
                                      ...
                                      __FILE__,
                                      __LINE__,
                                      "Not handling lzh Status");
    }else
    {
        msg_type=LIBLTE_MME_MSG_TYPE_TRACKING_AREA_UPDATE_REQUEST;
          interface->send_debug_msg(LTE_FDD_ENB_DEBUG_TYPE_ERROR,
                                      LTE_FDD_ENB_DEBUG_LEVEL_MME,
                                      __FILE__,
                                      __LINE__,
        ...
        case LIBLTE_MME_MSG_TYPE_ATTACH_REQUEST:
            ...
            nas_msg->rb->set_mme_procedure(LTE_FDD_ENB_MME_PROC_ATTACH_REJECT);
            break;
        ...
        case LIBLTE_MME_MSG_TYPE_TRACKING_AREA_UPDATE_REQUEST:
            ...
            nas_msg->rb->set_mme_procedure(LTE_FDD_ENB_MME_PROC_TAU_REJECT);
            break;
        ...
        //lzh 2018.6.02
        //触发identity request流程
        //nas_msg->rb->set_mme_procedure(LTE_FDD_ENB_MME_PROC_ATTACH);
        //lzh 2018.6.03
        //触发tau request流程
        ...
        case LTE_FDD_ENB_MME_PROC_DETACH:
            ...
            break;
        case LTE_FDD_ENB_MME_PROC_TAU_REJECT:
            send_tau_reject(nas_msg->user, nas_msg->rb);
        case LTE_FDD_ENB_MME_PROC_ATTACH_REJECT:
            send_attach_reject(nas_msg->user, nas_msg->rb);
        default:
            interface->send_debug_msg(LTE_FDD_ENB_DEBUG_TYPE_ERROR,
                                      LTE_FDD_ENB_DEBUG_LEVEL_MME,
                                      __FILE__,
                                           ...
                                           LTE_fdd_enb_rb         **rb)
{
    ...
    LIBLTE_MME_ATTACH_REQUEST_MSG_STRUCT  tau_req;

    interface->send_debug_msg(LTE_FDD_ENB_DEBUG_TYPE_INFO,
                              LTE_FDD_ENB_DEBUG_LEVEL_MME,
                              __FILE__,
                              __LINE__,
                              "Received tau Complete for RNTI=%u and RB=%s",
                              (*user)->get_c_rnti(),
                              LTE_fdd_enb_rb_text[(*rb)->get_rb_id()]);
}
                                              ...
                                              LTE_fdd_enb_rb         *rb)
{
    ...
    // Store the ID
/*
if(LIBLTE_MME_MOBILE_ID_TYPE_IMEI == id_resp.mobile_id.type_of_id){
        for(i=0; i<15; i++)
        {
            imei_num *= 10;
                                ...
                                LTE_fdd_enb_rb   *rb)
{
    ...
    //lzh 2018.6.02
    rb->set_mme_state(LTE_FDD_ENB_STATE_ID_REQUEST_IMEI);
    ...
    case LTE_FDD_ENB_MME_STATE_ID_REQUEST_IMSI:
        ...
        break;
    case LTE_FDD_ENB_STATE_ID_REQUEST_IMEI:
        send_identity_request(user, rb, 1);
        break;
...
//lzh 2018.6.03
/*tau　reject*/
void LTE_fdd_enb_mme::send_tau_reject(LTE_fdd_enb_user *user,
                                         LTE_fdd_enb_rb   *rb)
{
    uint8                                   sec_hdr_type;
    uint8                                   *key_256;
    ...
    interface->send_debug_msg(LTE_FDD_ENB_DEBUG_TYPE_INFO,
                              ...
                              __FILE__,
                              __LINE__,
                              "Sending Tracking area update Reject for IMSI=%015llu, RNTI=%u, RB=%s",
                              imsi_num,
                              user->get_c_rnti(),
                              LTE_fdd_enb_rb_text[rb->get_rb_id()]);
...
//lzh 2018.6.01添加identity request
